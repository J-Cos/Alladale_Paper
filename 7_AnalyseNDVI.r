...
#make plots (3, S1, 4, S2)
    ...
    p6<-plotNdviAgainstLcChange( mk_MINNDVI_res, MINNDVI_smooth, LCchange, mask=Alladale, ComparatorArea=Enclosures)
        ...
        png(file.path("Figures","Figure4.png"), height = 6, width = 12, units = 'in', res = 300)
            cowplot::ggdraw() +
                ...
                cowplot::draw_label("Buffer", x=0.02, y=0.85, size = 14, angle = 90)+
                cowplot::draw_label("Alladale", x=0.02, y=0.65, size = 14, angle = 90)+
                cowplot::draw_label("Alladale excl.\nenclosures", x=0.02, y=0.38, size = 14, angle = 90)+
                cowplot::draw_label("Enclosures", x=0.02, y=0.17, size = 14, angle = 90)
        dev.off()
    ...
    p6<-plotNdviAgainstLcChange( mk_MINNDVI_monthly_res, MINNDVI_monthly, LCchange, mask=Alladale, ComparatorArea=Enclosures, xlims=c(-2048, 2048))
        ...
        png(file.path("Figures","FigureS2.png"), height = 6, width = 12, units = 'in', res = 300)
            cowplot::ggdraw() +
    ...
    #fig 3
        ...
        png(file.path("Figures","Figure3.png"), height = 6, width = 12, units = 'in', res = 300)
            cowplot::ggdraw() +
    ...
    #fig S1
        ...
        png(file.path("Figures","FigureS1.png"), height = 6, width = 12, units = 'in', res = 300)
            cowplot::ggdraw() +
